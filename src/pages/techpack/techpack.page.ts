...
/**
 * Owned by the Techpack QA. Add this module's real locators/actions here
 * — nothing else in the framework needs to change to extend Techpack coverage.
 */
export class TechpackPage extends BasePage {
  ...
  constructor(page: Page) {
    super(page);
    // TODO(Techpack QA): replace with a locator specific to this module's
