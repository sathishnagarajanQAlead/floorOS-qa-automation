...
/**
 * Owned by the Planning QA. Add this module's real locators/actions here
 * — nothing else in the framework needs to change to extend Planning coverage.
 */
export class PlanningPage extends BasePage {
  ...
  constructor(page: Page) {
    super(page);
    // TODO(Planning QA): replace with a locator specific to this module's
